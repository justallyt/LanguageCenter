              ...
              <div className="inner-row">
                          <div className="reasons-section-content">
                                      <div className="reasons-intro">
                                                 ...
                                                 <h1 className={plusJakarta.className}>Upgrade Your Language Skills</h1>
                                      </div>
                                      <div className="reasons-wrapper">
                                      <div className="reason-moja">
                                                          <Image src='/assets/trustees.png' width={50} height={50} alt='' />
                                               ...
                                               <div className="reason-moja">
                                                           <Image src='/assets/certificate.png' width={50} height={50} alt='' />
                                                          <div className="reason-text">
                                               ...
                                               <div className="reason-moja">
                                                         <Image src='/assets/support.png' width={50} height={50} alt='' />
                                                          <div className="reason-text">
                                               ...
                                               <div className="reason-moja">
                                                          <Image src='/assets/professionals.png' width={50} height={50} alt='' />
                                                          <div className="reason-text">
                                               ...
                                               <div className="reason-moja">
                                                           <Image src='/assets/serene.png' width={50} height={50} alt='' />
                                                          <div className="reason-text">
                                               ...
                                               <div className="reason-moja">
                                                         <Image src='/assets/diversity.png' width={50} height={50} alt='' />
                                                          <div className="reason-text">
